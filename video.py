...
def run_transnet(video_path):
    os.system(f'python "TransNetV2/inference/transnetv2.py" "{video_path}"')

    scene_file = video_path + ".scenes.txt"
...
def main():
    ...
    scenes, duration = run_transnet(args.input)
    ...
    out_path = os.path.join(args.output_dir, "video_signals.json")
